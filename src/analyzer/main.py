...
def setup_and_run():
    ...
    # os.environ["LEROBOT_DATA_DIR"] = data_dir
    logger.info(f"LEROBOT_DATA_DIR configured: {os.getenv('LEROBOT_DATA_DIR')}")
    ...
    parser.add_argument("--n_action_steps", type=int, default=50, help="Num of action steps")
