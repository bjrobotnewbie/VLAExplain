# 🧠 VLAExplain — $\pi_{0.5}$ model attention analysis



$\pi_{0.5}$ model attention analysis supportes:
...
```bash
bash src/lerobot/scripts/mv_key_files.sh
```
...
```bash
bash src/lerobot/scripts/libero_eval.sh
```
...
```bash
bash src/lerobot/scripts/run_analyzer.sh
```
